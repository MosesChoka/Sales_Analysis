...
---
We have three data sets, one for the central region, one for eastern, and one for the western region.  We need to edit the code below for the path to the files.
...
```
For this project, we intend to answer the following questions, but please note: the data may or may not be setup such that you can just answer. We may need to perform some "data wrangling" before we can answer.
